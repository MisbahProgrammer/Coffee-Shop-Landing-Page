...
function Main() {
  return (
    <div className='flex flex-col mt-10 md:flex-row items-center justify-center gap-4 lg:gap-[240px] lg:mr-10 mx-auto w-[90%] md:content-center content-center'>
        ...
        <div className='w-[80%] lg:w-[33%] p-4'>
